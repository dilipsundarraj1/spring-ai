 ...
 * and talks to it over the streamable HTTP transport. The weatherapi.com backend is
 * replaced by a WireMock stub so the full pipeline — tool call, WebClient request, JSON
...
class McpWeatherServerWebFluxIntegrationTest {
	...
	void stubWeatherApiAndConnect() {
		...
		assertThat(initResult.serverInfo().name()).isEqualTo("my-weather-server-webflux");
	}
	...
	private static String readResource(String path) {
		try (var in = McpWeatherServerWebFluxIntegrationTest.class.getResourceAsStream(path)) {
